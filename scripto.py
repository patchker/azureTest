        ...
        try:
            ...
            try:
                if massorsingle == "1" and attacktype == "FAKE":
                    try:
                        ...
                        return False, "E.15 - Blad przy usuwaniu obrazka jebanego",0,"Brak"
                ...
                return False, "E.11 - Błąd podczas wpisywania celu",0,"Brak"
            ...
            try:
                while True:  # Pętla nieskończona, jak w setInterval w JavaScript
                    ...
                    time.sleep(0.005)  # Odczekaj 5 ms, podobnie jak w JavaScript
            except:
